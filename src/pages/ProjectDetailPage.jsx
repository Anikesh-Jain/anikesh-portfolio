  ...
  return (
    <div className="shell py-4 sm:py-8 space-y-12">
        ...
        <div className="flex flex-wrap items-center gap-3 pt-2">
          {project.links?.demo && (
            <a
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-white font-medium text-sm transition-all shadow-md shadow-purple-600/20"
            >
          ...
          {project.links?.repo && (
            <a
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-[#0d1120] border border-[#1e243b] hover:border-purple-500/40 text-foreground font-medium text-sm transition-all hover:bg-[#13182c]"
            >
              ...
              <ExternalLink className="w-3.5 h-3.5 text-[#636177]" />
            </a>
          )}
          ...
          {project.links?.linkedin && (
            <a
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-[#0d1120] border border-[#1e243b] hover:border-[#0077b5]/50 text-foreground font-medium text-sm transition-all hover:bg-[#13182c]"
            >
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="p-6 sm:p-8 rounded-2xl bg-[#0d1120] border border-[#1e243b] space-y-4">
      ...
      {project.video?.available && (
        <section className="p-6 sm:p-8 rounded-2xl bg-[#0d1120] border border-[#1e243b] space-y-6">
        ...
        <section className="p-6 sm:p-8 rounded-2xl bg-[#0d1120] border border-[#1e243b] space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 pt-2">
            {project.features.map((feat, idx) => (
              <div
                key={idx}
                className="p-5 rounded-xl bg-[#070912] border border-[#1e243b] hover:border-purple-500/30 transition-colors space-y-2"
              >
      ...
      {project.highlights && project.highlights.length > 0 && (
        <section className="p-6 sm:p-8 rounded-2xl bg-[#0d1120] border border-[#1e243b] space-y-4">
          <div className="flex items-center gap-2 text-xs font-mono text-purple-400">
            <Layers className="w-4 h-4" />
      ...
      {nextProject && (
        <section className="pt-6 border-t border-[#1e243b]">
          <Link
            ...
            className="p-6 sm:p-8 rounded-2xl bg-[#0d1120] border border-[#1e243b] hover:border-purple-500/40 flex flex-col sm:flex-row sm:items-center justify-between gap-4 group transition-all"
          >
            <div className="space-y-1">
